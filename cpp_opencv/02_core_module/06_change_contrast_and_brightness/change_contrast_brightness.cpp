...
{
    CommandLineParser parser( argc, argv, "{@input | ../../data/wechat.jpg | input image}" );
    ...
    hconcat(img_original, img_original, img_corrected);	//拼接图像，将第一个与第二个图像拼接成第三个
	...
	//第一个参数是调整棒的名字，第二个参数是窗口名，第三个参数为绑定的变量，第四个参数为范围，第五个参数为响应函数
